...
# #bg=ImageTk.PhotoImage(file="E:\\ARUL\\ICP\\password\\password.jpg")
# bg=PhotoImage(file='password.jpeg')
# # img=PhotoImage(file='password.jpg')
...
# Heading
w2 = Label(root, justify=LEFT, text="Disease Predictor ", fg="white", bg="grey")
...
dst = Button(root, text="Submit", command=DecisionTree,bg="green",fg="yellow")
dst.grid(row=15, column=1,pady=10,sticky=W)

lrLb = Label(root, text="Your health issue is", fg="white", bg="red")
